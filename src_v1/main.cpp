...
int main(int argc, const char * argv[]){
    ...
    if (argc == 3)
    {
        std::string imginput = argv[1];
        std::string vidinput = argv[2];

        cv::Mat testImage = cv::imread(imginput);
