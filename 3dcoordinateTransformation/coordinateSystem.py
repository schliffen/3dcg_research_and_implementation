...
def main(openGLGlyphs):
    # setup and run OpenGL
    glutInit()
    glutInitDisplayMode(GLUT_RGBA | GLUT_DOUBLE | GLUT_DEPTH)
    glutInitWindowSize(640, 480)
    glutInitWindowPosition(800, 400)
    openGLGlyphs.window_id = glutCreateWindow("OpenGL Glyphs")
    glutDisplayFunc(openGLGlyphs._draw_scene)
    glutIdleFunc(openGLGlyphs._draw_scene)
    openGLGlyphs._init_gl(640, 480)
    glutMainLoop()
